@extends('layout.bootstrapmenu.index')
    ...
    <div class="panel-body">
        ...
        <div id="slideshow-mudah" class="carousel slide" data-ride="carousel">
            ...
            <ol class="carousel-indicators">
                ...
                <li data-target="#slideshow-mudah" data-slide-to="4"></li>
            </ol>

            <!-- Wrapper for slides, Ini adalah Tempat Gambar-->
            <div class="carousel-inner">
                <div class="item active">
                    <img src="img/1c.png" alt="slideshow-mudah" class="img-responsive"> <!—Gambar -->
                    <div class="carousel-caption"> <!—Penjelasan -->
                       
                    </div>
                </div>
                <div class="item">
                    <img class="" src="img/2c.png" alt="slideshow-mudah"> <!—Gambar -->
                    <div class="carousel-caption">  <!—Penjelasan -->
                    </div>
                </div>
                <div class="item">
                    <img src="img/3c.png"> <!—Gambar -->
                    <div class="carousel-caption"> <!—Penjelasan -->
                    </div>
                </div>
                <div class="item">
                    <img src="img/4c.png"> <!—Gambar -->
                    <div class="carousel-caption"> <!—Penjelasan -->
                    </div>
                </div>
                <div class="item">
                    <img src="img/5c.png"> <!—Gambar -->
                    <div class="carousel-caption"> <!—Penjelasan -->                        
                    </div>
                </div>
